<template>
  <label class="bb8-toggle" :title="theme.theme.value === 'light' ? '切换到暗潮模式' : '切换到亮昼模式'">
    <input
      type="checkbox"
      class="bb8-toggle__checkbox"
      :checked="theme.theme.value === 'light'"
      @change="theme.toggleTheme"
    >
    <div class="bb8-toggle__container">
      <div class="bb8-toggle__scenery"></div>
      <!-- 星星元素 -->
...
<style scoped>
.bb8-toggle {
    --toggle-size: 6px; /* Scaled down base size */
